    ...
    eb: [
      {
        ...
        bio: "'In a world where silence is often mistaken for peace, true change requires voices to speak up and actions to follow.'Sanjitha Moka has dedicated herself to being that voice of change at her college. With a background in debates that traces back to her school days, she's honed her ability to articulate complex issues and rally others to action. As an integral member of Stentorian and VJ MUNSoc, she orchestrated numerous events and sometimes even winning them. When she isn’t breaking down business ideas on a whiteboard, over-analysing life decisions, you’ll usually find her with her headphones on, hopping away and when she’s stuck indoors, she’s probably binging Brooklyn 99 because, 𝘴𝘩𝘩𝘩, she’s 𝘯𝘰𝘵 𝘢 𝘥𝘰𝘤𝘵𝘰𝘳. She's excited to be back at REQMUN 3.0."
      },
      {
      ...
      {
        name: "Chakresh",
        role: "Moderator for Cabinet 1",
        image: "images/chakresh.jpeg",
        bio: "Between reading webtoons, getting lost in films, and writing short stories at odd hours, Chakresh tends to live half in reality and half in fiction and he’s perfectly fine with that balance. Stories, in all their forms, are his favorite way to make sense of the world or at least pretend to."
      }
    ],
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.openSecretariatModal = function (memberId) {
    ...
    if (data.instagram) {
      instagramHtml = `
        <div class="modal-instagram-wrapper">
          <a href="https://instagram.com/${data.instagram}" target="_blank" rel="noopener noreferrer" class="modal-instagram">

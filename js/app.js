...
const committeesData = {
  ...
  jcc: {
    ...
    eb: [
      ...
      {
        name: "Zhoreh Tejam",
        role: "Assistant moderator - cabinet i",
    ...
    setTimeout(() => {
      ...
      panel.innerHTML = `
        <div class="comm-title-row">
          ...
          <div class="comm-title-logo-container">
            <img src="${data.logo}" alt="${data.shortName} Logo" class="comm-title-logo">
          </div>
        </div>

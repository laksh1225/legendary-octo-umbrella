...
const committeesData = {
  unsc: {
    ...
    eb: [
      { name: "Diana Prince", role: "Chairperson" },
      { name: "Arthur Curry", role: "Vice-Chairperson" }
    ],
    guideName: "UNSC_RMUN2026_Background_Guide.pdf"
  },
  disec: {
    id: "disec",
    shortName: "DISEC",
    ...
    eb: [
      { name: "Bruce Wayne", role: "Chairperson" },
      { name: "Clark Kent", role: "Vice-Chairperson" }
    ],
    guideName: "DISEC_RMUN2026_Background_Guide.pdf"
  },
  unhrc: {
    id: "unhrc",
    shortName: "UNHRC",
    ...
    eb: [
      { name: "Selina Kyle", role: "Chairperson" },
      { name: "Barry Allen", role: "Vice-Chairperson" }
    ],
    guideName: "UNHRC_RMUN2026_Background_Guide.pdf"
  },
  unep: {
    id: "unep",
    shortName: "UNEP",
    ...
    eb: [
      { name: "Pamela Isley", role: "Chairperson" },
      { name: "Victor Stone", role: "Vice-Chairperson" }
    ],
    guideName: "UNEP_RMUN2026_Background_Guide.pdf"
  },
  who: {
    id: "who",
    shortName: "WHO",
    ...
    eb: [
      { name: "Harleen Quinzel", role: "Chairperson" },
      { name: "Hal Jordan", role: "Vice-Chairperson" }
    ],
    guideName: "WHO_RMUN2026_Background_Guide.pdf"
  },
  loksabha: {
    id: "loksabha",
    shortName: "Lok Sabha",
    ...
    eb: [
      { name: "Pranab Mukherjee", role: "Speaker" },
      { name: "Sonia Gandhi", role: "Deputy Speaker" }
    ],
    guideName: "Lok_Sabha_RMUN2026_Background_Guide.pdf"
  }
};
